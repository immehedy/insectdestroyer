...
export default async function Home() {
  // const res = await contentfulClient?.getEntries({ content_type: 'insecdestroyerLanding' })
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white text-center py-4 px-4 mb-4">
          <h2 className="text-xl md:text-2xl font-bold">{"অর্ডার করতে নিচের ফর্মটি পূরণ করুন ⬇️"}</h2>
        </div>
