          ...
          <div className="lg:col-span-2">
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  {
                    "সিডার অয়েল ছারপোকা মারতে খুবই কার্যকর এবং মানুষের জন্য নিরাপদ।"
                  }
                </p>
              </div>
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  {
                    "পেপারমিন্ট অয়েল এর গন্ধে ছারপোকা পালিয়ে যায় এবং মানুষ ভাল লাগে।"
                  }
                </p>
              </div>
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  {
                    "ল্যাভেন্ডার অয়েল ৯৯% ছারপোকা মেরে ফেলে এবং ভবিষ্যতে আসতে বাধা দেয়।"
                  }
                </p>
              </div>
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  {
                    "তিনটি অয়েল একসাথে মিশিয়ে স্প্রে করলে ১০০% কার্যকর ফলাফল পাবেন।"
                  }
                </p>
              </div>
            </div>
